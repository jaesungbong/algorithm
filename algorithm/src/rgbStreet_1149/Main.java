...
public class Main {
	public static void main(String[] args) {
		...
		price[0][0] = sc.nextInt(); //첫번째 집이 빨간색일 때 첫번쨰 집을 칠하는 비용
		price[1][0] = sc.nextInt(); //첫번째 집이 초록색일 때 첫번째 집을 칠하는 비용
		price[2][0] = sc.nextInt(); //첫번째 집이 파랑색일 때 첫번재 집을 칠하는 비용
